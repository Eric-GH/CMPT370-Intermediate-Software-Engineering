...
public class SearchDishes {
    ...
    public void Search(String search) {
        ...
        if (search.equals("") || search.equals(null)) {
            ...
            Query = "select r.id, r.restaurant_name, l.house_num, l.street, l.city, l.province,\n " +
    ...
    public void setSortInfos(ResultSet resultSet) {
        try {
            ...
            sortInfo.setDish_Name(resultSet.getString(9));
            sortInfo.setDish_price(resultSet.getInt(10));
    ...
    public void sortByPrice() {
        Collections.sort(sortInfos,SortInfo.dishPriceComparator);
    }
    ...
    public void printSuperArray() {
        for (int i = 0; i < sortInfos.size(); i++) {
            System.out.println(sortInfos.get(i).dishToString());
        }
    }
    ...
    public static void main(String[] argcs){
        ...
        searchDishes.Search("chicken");
        searchDishes.sortByPrice();
        //searchDishes.sortByDistance(2);
        searchDishes.printSuperArray();
